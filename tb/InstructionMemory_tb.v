...
module InstructionMemory_tb;
    ...
    initial begin
        ...
        expected[1] = 16'b0000010001000001;
        expected[2] = 16'b0010000001010000;
        expected[3] = 16'b0001000010000000;
        expected[4] = 16'b0011001000011000;
        expected[5] = 16'b0111000001100000;
        expected[6] = 16'b1000000001101000;
        expected[7] = 16'b1001000001110000;
        expected[8] = 16'b1011000011000001;
        expected[9] = 16'b1010000000000000;
        expected[10] = 16'b1100000001000001;
        expected[11] = 16'b1010000000000000;
        expected[12] = 16'b1010000000000000;
        expected[13] = 16'b1010000000000000;
        expected[14] = 16'b1101000000100000;
